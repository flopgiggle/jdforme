...
namespace WindowsFormsApp1
{
    ...
    public class HttpHelper
    {
        ...
        public HttpHelper(bool openSession,string userName) {
            ...
            if (!SessionDic.userCookies.ContainsKey(userName)) {
                SessionDic.userCookies.Add(userName, "");
            }
        }
        ...
        private void GetData(HttpItem item, HttpResult result)
        {
            ...
            {
                if (userName != "") {
                    SessionDic.userCookies[userName] = response.Headers["set-cookie"];
                }
        ...
        {
            if (isOpenSession && userName!="" && SessionDic.userCookies[userName].Length > 0) {
                request.Headers[HttpRequestHeader.Cookie] = SessionDic.userCookies[userName];
            }
